...
var bindEvent = function bindEvent(record, maxDuration, maxJump) {
...
exports.default = {
  init: function init() {
    ...
    var maxDuration = options.maxDuration || 5000;
    var maxJump = options.maxJump || 5;
    var source = options.source || location.href;

    var record = _storage2.default.inc(source, document.referrer, maxDuration);
